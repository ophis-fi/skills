...
This root policy applies to the whole `ophis-fi/skills` repository. The same policy, scoped to the plugin, is mirrored at [`plugins/ophis/SECURITY.md`](plugins/ophis/SECURITY.md).
